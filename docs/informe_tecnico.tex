...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|}
        ...
        \hline\hline
        Victim1 & \texttt{FLAG\{hidden\_in\_html\}} & Comentario HTML en la p\'agina web \\
        \hline
        Victim2 & \texttt{FLAG\{leaked\_credentials\}} & Archivo \texttt{/backup/db\_credentials.txt} \\
        \hline
        Victim3 & \texttt{FLAG\{intercepted\_token\}} & Campo \texttt{auth\_token} en POST HTTP \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|l|X|}
        ...
        \hline\hline
        1 & \texttt{FLAG\{hidden\_in\_html\}} & 100 & Inspecci\'on de c\'odigo fuente HTTP \\
        \hline
        2 & \texttt{FLAG\{leaked\_credentials\}} & 150 & Acceso a archivo de backup v\'ia HTTP \\
        \hline
        3 & \texttt{FLAG\{intercepted\_token\}} & 200 & Interceptaci\'on de POST HTTP (MITM) \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|}
        ...
        \hline
        Integraci\'on Wazuh & Dashboard operativo & Exitoso \\
        \hline
